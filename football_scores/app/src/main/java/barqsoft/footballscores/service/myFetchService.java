        ...
        try {
            ...
            for(int i = 0;i < matches.length();i++)
            {
                        ...
                        League.equals(DUMMYLEAGUE) )
                {
                    ...
                    SimpleDateFormat match_date = new SimpleDateFormat(getString(R.string.date_year_month_day_hour_min_sec));
                    match_date.setTimeZone(TimeZone.getTimeZone("UTC"));
                    try {
                        Date parseddate = match_date.parse(mDate+mTime);
                        SimpleDateFormat new_date = new SimpleDateFormat(getString(R.string.date_year_month_day_hour_min));
